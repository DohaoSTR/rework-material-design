...
public static class PasswordBoxAssist
{
    ...
    public static void SetHelpButtons(DependencyObject element, ObservableCollection<HelpButton> value) => element.SetValue(HelpButtonsProperty, value);

    public static ObservableCollection<HelpButton> GetHelpButtons(DependencyObject element) => (ObservableCollection<HelpButton>)element.GetValue(HelpButtonsProperty);

    public static readonly DependencyProperty RevealToolTipTextProperty = DependencyProperty.RegisterAttached(
    "RevealToolTipText", typeof(string), typeof(PasswordBoxAssist), new FrameworkPropertyMetadata("Кнопка «Показать/Скрыть пароль»", FrameworkPropertyMetadataOptions.Inherits));
    public static void SetRevealToolTipText(DependencyObject element, string value) => element.SetValue(RevealToolTipTextProperty, value);
    public static string GetRevealToolTipText(DependencyObject element) => (string)element.GetValue(RevealToolTipTextProperty);
